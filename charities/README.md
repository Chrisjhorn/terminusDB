...
The full dataset contains some 20,000 charities.  For the purposes of the demo,  a random subset of 500 have been used,  purely so that the loading time (of the raw data into the graph base) does not take too long.
